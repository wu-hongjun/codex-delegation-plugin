...
| 2 — Implement | `2-implement.md` | **in progress 2026-06-05** — T1+T2 docs and T3a probe dispatching in parallel via executor subagents; T3b serial after T3a returns |

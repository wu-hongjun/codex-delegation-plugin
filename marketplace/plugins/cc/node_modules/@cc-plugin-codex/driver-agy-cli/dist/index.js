...
export class AgyCliDriver {
    ...
    send(_session, _input, _opts) {
        return Promise.reject(new DriverError('agy CLI follow-up is unavailable because print mode does not return a stable conversation ID; global --continue is intentionally not used.', { driverName: DRIVER_NAME, operation: 'send' }));
    }
    async dispose() { }
}

...
export type TurnStatus = 'queued' | 'starting' | 'injecting' | 'working' | 'needs_input' | 'completed' | 'failed';
...
export type SessionStatusValue = 'queued' | 'starting' | 'working' | 'needs_input' | 'idle' | 'completed' | 'failed' | 'stopped' | 'orphaned' | 'unknown';

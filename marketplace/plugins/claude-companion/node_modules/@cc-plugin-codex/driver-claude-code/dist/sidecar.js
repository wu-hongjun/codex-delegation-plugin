 ...
 */
export function resolveSidecarPath(shortId, opts) {
 ...
 */
export function parseSidecarSnapshot(raw) {
    const snapshot = { raw };
    ...
    if (inFlight !== null && typeof inFlight === 'object' && !Array.isArray(inFlight)) {
        ...
        if (Array.isArray(ifo['kinds'])) {
            const stringKinds = ifo['kinds'].filter((k) => typeof k === 'string');
 ...
 */
export async function readSidecar(shortId, opts) {

...
function printUsage() {
  process.stdout.write(
    [
      ...
      '  --yes                        Acknowledge privacy disclosure automatically (delegate/followup/review/adversarial-review)',
      '  --name <name>                Session name (delegate only)',
      '  --model <model>              Model selection (delegate, adversarial-review)',
      '  --effort <effort>            Effort level (delegate, adversarial-review)',
      '  --permission-mode <mode>     Permission mode (delegate, adversarial-review)',
      '  --add-dir <dir>              Additional directory (delegate only; repeatable)',
      '  --mcp-config <path>          MCP config file (delegate only)',
      '  --allow-edit                 Policy/framing flag (delegate, followup); does NOT bypass the privacy acknowledgement and is rejected by review and adversarial-review',

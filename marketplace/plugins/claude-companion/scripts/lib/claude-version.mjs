// claude-version.mjs — semver parsing helpers for the claude-companion doctor probes.
//
// Pure ESM module. No external dependencies. Used by claude-companion.mjs to parse

export declare const DRIVER_NAME = "agy-cli";
export declare const DRIVER_VERSION = "0.0.0";
...
export type AgyRunnerStatus = 'starting' | 'running' | 'needs_input' | 'idle' | 'completed' | 'failed' | 'stopped';

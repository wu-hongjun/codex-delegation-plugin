 ...
 */
export declare function mapStatus(input: StatusMappingInput): JobStatus;
export declare function reconcileJob(jobId: string, adapter: ReconcilerAdapter, options?: ReconcileOptions): Promise<ReconcileResult>;
export declare function reconcileJobsForWorkspace(workspaceRoot: string, adapter: ReconcilerAdapter, options?: ReconcileOptions): Promise<ReconcileWorkspaceResult>;

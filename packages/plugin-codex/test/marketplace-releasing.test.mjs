...
describe('consolidated release checklist (Plan 0006 T11)', () => {
  ...
  // ========================================================================
  // T11-6: Smoke Test section enumerates all 15 skills + gate criterion
  // ========================================================================

  it('Smoke Test section enumerates all 15 skills with $claude-setup as gate (ok/warn)', () => {
    const content = readFileSync(RELEASING_MD, 'utf8');
  ...
  // ========================================================================
  // T11-8: Tagging section requires smoke + CI before tag + has v0.3.10 example
  // ========================================================================

  it('Tagging section gates on smoke + CI and shows v0.3.10 example', () => {
    const content = readFileSync(RELEASING_MD, 'utf8');
    assert.match(
      content,
    ...
    assert.ok(
      content.includes('v0.3.10'),
      'Tagging section must include the current example tag `v0.3.10`',
    );
    assert.match(
      content,

 ...
 * assertions only and prints the fourteen-skill manual checklist for the
 ...
 *   8. Prints the fourteen-skill manual TUI checklist.
...
// All fourteen skills shipped by the cc-plugin-codex marketplace plugin. Order
...
function printHelp() {
  process.stdout.write(
    [
      ...
      'skill-invocation interface, so the fourteen-skill discovery check must',
...
process.stdout.write(
  [
    ...
    '  - The other 13 skills do not return "unknown skill" or',
